...
class AgentManifest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specs": AgentACPSpecs.from_dict(obj["specs"]) if obj.get("specs") is not None else None,
            "deployment": AgentDeployment.from_dict(obj["deployment"]) if obj.get("deployment") is not None else None
        })
        return _obj
