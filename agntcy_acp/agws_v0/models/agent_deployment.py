...
class AgentDeployment(BaseModel):
    ...
    dependencies: List[AgentReference] = Field(description="List of all other agents this agent depends on")
    __properties: ClassVar[List[str]] = ["deployment_options", "dependencies"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.deployment_options:
            for _item_deployment_options in self.deployment_options:
                if _item_deployment_options:
                    _items.append(_item_deployment_options.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deployment_options": [AgentDeploymentDeploymentOptionsInner.from_dict(_item) for _item in obj["deployment_options"]] if obj.get("deployment_options") is not None else None,
            "dependencies": [AgentReference.from_dict(_item) for _item in obj["dependencies"]] if obj.get("dependencies") is not None else None
        })
        return _obj
